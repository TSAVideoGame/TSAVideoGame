...
var ASM_CONSTS = {
  10692: function() {alert("Confirm to begin")},  
 10718: function() {var window = document.createElement('canvas'); window.id = 'JIN_WINDOW'; document.body.appendChild(window)}
};
