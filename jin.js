...
var ASM_CONSTS = {
  10740: function() {alert("Confirm to begin")},  
 10766: function() {var window = document.createElement('canvas'); window.id = 'JIN_WINDOW'; document.body.appendChild(window)}
};
