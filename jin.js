...
var ASM_CONSTS = {
  8728: function() {alert("Confirm to begin")},  
 8754: function() {var window = document.createElement('canvas'); window.id = 'JIN_WINDOW'; window.style.backgroundColor = '#000'; document.body.appendChild(window)}
};
