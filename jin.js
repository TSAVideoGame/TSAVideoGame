...
var ASM_CONSTS = {
  10820: function() {alert("Confirm to begin")},  
 10846: function() {var window = document.createElement('canvas'); window.id = 'JIN_WINDOW'; document.body.appendChild(window)}
};
